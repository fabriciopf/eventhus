...
# Examples
[bank account](https://github.com/fabriciopf/eventhus/blob/master/examples/bank) shows a full example  with `deposits` and `withdrawls`
...
```go
import "github.com/fabriciopf/eventhus/config"
...
